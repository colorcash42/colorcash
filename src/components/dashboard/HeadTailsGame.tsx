...
function ResultDialog({ isOpen, onOpenChange, result, betAmount }: { isOpen: boolean, onOpenChange: (isOpen: boolean) => void, result: any, betAmount: number }) {
    ...
    return (        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="text-center">
                ...
                <div className="my-6">
                    <div className="w-24 h-24 mx-auto rounded-full flex items-center justify-center shadow-lg bg-secondary">
                        <span className="text-4xl font-bold">{winningSide}</span>
                    </div>
                </div>
    ...
    <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
            ...
            <div className="relative">
                ...
                <Input id="bet-amount-headtails" type="number" value={amount} onChange={e => setAmount(e.target.value)} className="pl-6" />
            </div>
